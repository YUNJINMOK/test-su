        ...
        <form onSubmit={handleSubmit(onValid)} action="" className="flex flex-col mb-2">
          ...
          <div className="flex flex-col mb-6">
            <div className="relative">
              <input {...register("password1")} name="password1" className={`w-[300px] h-[50px] rounded-lg border-none ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-[#119724] ${errors.hasOwnProperty("password1") && "ring-red-500"}`} type={type ? "password" : "text"} placeholder="비밀번호" />
          ...
          <div className="relative">
            <input {...register("password2")} name="password2" className="w-[300px] h-[50px] rounded-lg border-none ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-[#119724]" type={type2 ? "password" : "text"} placeholder="비밀번호 확인" />
            <div onClick={() => setType2(!type2)} className="absolute top-[2px] right-[5px] px-3 py-[6px] bg-white">
