      ...
      <div className="w-full flex flex-col items-center py-16">
        ...
        <form onSubmit={handleSubmit(onValid)} className="flex flex-col mb-2">
          ...
          <div className="flex flex-col mb-6">
            <div className="relative">
              <input {...register("user_pw")} className={`w-[300px] h-[50px] rounded-lg border-none ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-[#119724] ${errors.hasOwnProperty("user_pw") && "ring-red-500"}`} type={type ? "password" : "text"} placeholder="비밀번호" />
        ...
        <div className="w-[300px] h-[50px] bg-[#FEE500] rounded-lg flex justify-around items-center mb-2">
          ...
          <Link to={finalUrl} className=" no-underline text-black">
            <p className="flex items-center justify-center text-xl font-semibold">카카오 로그인</p>
          </Link>
        ...
        <div className="w-[300px] h-[50px] bg-[#F2F2F2] rounded-lg flex justify-around items-center mb-2">
          ...
          <Link to={googleUrl} className=" no-underline text-black">
            <p className="flex items-center justify-center text-xl font-semibold">구글 로그인</p>
          </Link>
          <span className="w-[10%]"></span>
        </div>
